...
echo mpi_carousel("main-showcase", array(
  ...
  "Kasia" => "Rysuję właściwie od zawsze, a od kilku lat również piszę – wiersze, prozę, do wyboru!",
  "Keram" => "B-boy",
  "Michcioperz" => "Tutaj kiedyś będzie intro :P",
  "Misiek" => "genialny kaskader, marzy o różowym rowerku"
));
